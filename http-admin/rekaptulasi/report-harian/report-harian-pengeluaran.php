<?php
	...
	$sql = mysqli_query($con, "SELECT * FROM tb_pengeluaran WHERE tanggal='$tgl'");
		...
		<table class="table table-bordered mt-3" style="">
			...
			<tr>
				...
				<td style="text-align: right!important;">
					<?php 
						$sql = mysqli_query($con, "SELECT sum(jumlah) as pemasukan FROM tb_pengeluaran WHERE tanggal='$tgl'");
