<?php
	...
	$sql = mysqli_query($con, "SELECT * FROM tb_pemasukan WHERE year(tanggal)='$tahun' AND month(tanggal)='$bulan'");
...
<body>
	<div class="container-fluid p-3">
		...
		<table class="table table-bordered mt-3" style="">
			...
			<?php endforeach; ?>
			<tr>
				<td class="text-center" colspan="" style="font-weight: bold;">Total Kas Masuk</td>
				<td style="text-align: right!important;">
					<?php 
						$sql = mysqli_query($con, "SELECT sum(jumlah) as pemasukan FROM tb_pemasukan WHERE year(tanggal)='$tahun' AND month(tanggal)='$bulan'");
