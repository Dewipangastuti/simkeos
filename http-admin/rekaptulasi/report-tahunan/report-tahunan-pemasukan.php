<?php
	...
	$sql = mysqli_query($con, "SELECT * FROM tb_pemasukan WHERE year(tanggal)='$tahun'");
...
<body>
	<div class="container-fluid p-3">
		<h3 class="text-center">DATA LAPORAN PEMASUKAN TAHUNAN</h3>
		<table class="table table-bordered mt-3" style="">
			...
			<tr>
				...
				<td style="text-align: right!important;">
					<?php 
						$sql = mysqli_query($con, "SELECT sum(jumlah) as pemasukan FROM tb_pemasukan WHERE year(tanggal)='$tahun'");
